...
function SearchBarLg() {
  ...
  return (
    <div ref={inputRef} className={`group relative flex items-center rounded-full bg-[--background-tinted-base] hover:bg-[--background-tinted-press] h-[50px] w-[330px] text-sm border-[1px] hover:border-solid border-transparent 
      ${inputFocused ? 'border-white' : 'hover:border-[--background-tinted-highlight]'} `}>
        <svg className={`absolute left-[20px] group-hover:text-white ${searchVal ? 'text-white' : ''}  `}
        ...
        <input
          ...
          className="w-full h-full py-4 ps-12 pe-12 bg-transparent outline-none text-[--home-text-light] placeholder-[--home-text-subdued]"
        />
