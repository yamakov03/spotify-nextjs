                ...
                <div className={`rounded-md mb-2 ${preferences.sidebar === 'solarized' ? 'g' + getHours() + 'p ' : null} `}
                    ...
                    <div className=" p-4 rounded-md text-[--sidebar-text-subdued] font-semibold text-md ">
                        <button className={`flex items-center mb-4 space-x-3 ms-2 font-semibold hover:text-[--text-highlight] transition duration-200 ease-out ${view === "home" ? "text-[--text-highlight]" : null}`}
                            ...
                            <p className="@[80px]:visible invisible text-[16px]">Home</p>
                        </button>
                        <button className={`flex items-center space-x-3 ms-2 font-semibold hover:text-[--text-highlight] transition duration-200 ease-out ${view === "search" ? "text-[--text-highlight]" : null}`}
                            ...
                            <p className="@[80px]:visible invisible text-[16px]">Search</p>
                        </button>
                ...
                <div id='librarySidebar' className={`rounded-md ${preferences.sidebar === "solarized" ? getGradient() : preferences.sidebar === "accent" ? "bg-gradient-to-b from-[--background-base] to-[--background-press]" : null}`}
                    ...
                    <div className={`rounded-t-md z-40 text-[--sidebar-text-subdued]`}>
                        <div className={`px-2 flex justify-between items-center  pt-2 font-semibold text-md @[80px]:mb-0 mb-2 ${view === "library" ? "text-[--text-highlight]" : null}`}>
                            <button className="flex flex-shrink-0 items-center px-2 space-x-3 ms-2 hover:text-[--text-highlight] transition duration-200 ease-out" onClick={() => { parseInt(document.body.style.getPropertyValue("--left-width").substring(0, 3)) > 250 ? document.body.style.setProperty("--left-width", 80 + 'px') : document.body.style.setProperty("--left-width", 300 + 'px') }}>
                                ...
                                <p className="@[80px]:visible invisible text-[16px]">Your Library</p>
                            </button>
                        ...
                        <div className="@[80px]:flex hidden mt-2 ms-4 pb-2">
                    ...
                    <PerfectScrollbar className={`flex-wrap flex-col rounded-b-md overflow-y-scroll h-[calc(100vh-260px)] @[80px]:h-[calc(100vh-300px)]`} options={{ suppressScrollX: true }}>
                        ...
                        {sidebarView === "playlists" ?
                            <div className="rounded-md mb-1 @[80px]:mb-2">

                                <div id='playlists' className={`group hover:bg-[--background-tinted-highlight] cursor-pointer rounded-md px-2 py-2 mx-1 @[80px]:mx-2 ${view === "likedsongs" ? "bg-[--background-tinted-base]" : null}`}
                                    onClick={() => { { view != "likedsongs" ? (setIsLoading(true), setPlaylistId("liked"), setView("likedsongs")) : null }; }}>
                                ...
                                {filteredPlaylists.map((playlist) => (
                                    <div key={playlist.id} className={`group hover:bg-[--background-tinted-highlight] cursor-pointer rounded-md px-2 py-2 mx-1 @[80px]:mx-2 ${playlist.id === playlistId && view === "playlist" ? "bg-[--background-tinted-base]" : null}`}
                            ...
                            : sidebarView === "artists" ?
                                <div className="rounded-md mb-1 @[80px]:mb-2">
                                    {filteredArtists.map((artist) => (
                                        <div id='' key={artist.id} className={`group hover:bg-[--background-tinted-highlight] cursor-pointer rounded-md px-2 py-2 mx-1 @[80px]:mx-2 ${artist.id === artistsId && view === "artist" ? "bg-[--background-tinted-base]" : null}`}
                                ...
                                : sidebarView === "albums" ?
                                    <div className="rounded-md mb-1 @[80px]:mb-2">
                                        {filteredAlbums.map((album) => (
                                            <div key={album.album.id} className={`group hover:bg-[--background-tinted-highlight] cursor-pointer rounded-md px-2 py-2 mx-1 @[80px]:mx-2 ${album.album.id === albumsId && view === "album" ? "bg-[--background-tinted-base]" : null}`}
