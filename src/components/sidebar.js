...
function Sidebar() {
    ...
    return (
        <>
            <div id='sidebar' className="sidebar @container bg-[--background-press] text-[--sidebar-text-light] ps-2 pt-2 text-sm flex flex-col flex-shrink-0 h-[calc(100vh-5rem)] "
                onLoad={function () {

                }}>
                <div className={`rounded-md mb-2`}
                    style={{ backgroundColor: preferences.sidebar === "flat" ? preferences.sidebarColor : preferences.sidebar === "solarized" ? 
                    getComputedStyle(document.getElementById('solarizedGradient'))['background-image'].substring(
                        getComputedStyle(document.getElementById('solarizedGradient'))['background-image'].indexOf('rgb'),
                        getComputedStyle(document.getElementById('solarizedGradient'))['background-image'].indexOf(')')) : "var(--background-elevated-base)" }}>
                ...
                <div id='librarySidebar' className={`rounded-md ${preferences.sidebar === "solarized" ? getGradient() : preferences.sidebar === "accent" ? "bg-gradient-to-b from-[--background-base] to-[--background-press]" : null}`}
                    ...
                    <div className={`rounded-t-md z-40 pb-2  text-[--sidebar-text-subdued]`}>
                        <div className={`px-2 flex justify-between items-center  pt-2 font-semibold text-md ${view === "library" ? "text-[--text-highlight]" : null}`}>
                            <button className="flex flex-shrink-0 items-center px-2 space-x-3 ms-2 hover:text-[--text-highlight] transition duration-200 ease-out">
                        ...
                        <ScrollContainer className="@[80px]:flex hidden flex-row overflow-x-scroll overflow-auto whitespace-nowrap mt-4 ms-4 text-[--sidebar-text-light]">
                    ...
                    <PerfectScrollbar className={`flex-wrap flex-col rounded-b-md overflow-y-scroll h-[calc(100vh-260px)] @[80px]:h-[calc(100vh-308px)]`} options={{ suppressScrollX: true }}>
